...
if ( ! defined( 'ABSPATH' ) ) { exit;}
  if( !class_exists( 'Ni_WooCPR_Dashboard' ) ) {
	class Ni_WooCPR_Dashboard {
		...
		?>
        <div class="container-fluid" id="woocpr">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="card bg-rgba-green-slight">
                            <div class="card-header bg-rgba-green-strong"> <?php _e('Monitor your sales and grow your online business with naziinfotech plugins', 'woocpr'); ?> </div>
                            <div class="card-body">
                    ...
                    <div class="carousel-item">
                        <div class="card bg-rgba-cyan-slight">
                            <div class="card-header bg-rgba-cyan-strong"> <?php _e('Monitor your sales and grow your online business with naziinfotech plugins', 'woocpr'); ?> </div>
                            <div class="card-body">
                    ...
                    <div class="carousel-item">
                        <div class="card bg-rgba-indigo-slight">
                            <div class="card-header bg-rgba-indigo-strong"> <?php _e('Monitor your sales and grow your online business with naziinfotech plugins', 'woocpr'); ?> </div>
                            <div class="card-body">
                                <h2 class="card-title text-center color-rgba-indigo-strong"> <?php _e('Buy Ni WooCommerce Product Enquiry Pro @ $24.00', 'woocpr'); ?> </h2>
                               	<div class="row" style="font-size:16px">
                                	<div  class="col-md-3">
                                    	<span class="font-weight-bold color-rgba-black-strong"><?php esc_html_e('Dashboard Summary (Today, Total Enquiry)', 'woocpr'); ?></span><br />
                    ...
                    <div class="carousel-item">
                        <div class="card bg-rgba-blue-slight">
                            <div class="card-header bg-rgba-blue-strong"> <?php _e('Monitor your sales and grow your online business with naziinfotech plugins', 'woocpr'); ?> </div>
                            <div class="card-body">
                                <h2 class="card-title text-center color-rgba-blue-strong"> <?php _e('Ni One Page Inventory Management System For WooCommerce', 'woocpr'); ?> </h2>
                               	<div class="row" style="font-size:16px">
                                	<div  class="col-md-3">
                                    	<span class="font-weight-bold color-rgba-black-strong"><?php esc_html_e('Dashboard Summary stock status', 'woocpr'); ?></span><br />
            	...
            	<div class="col-md-12">
         			<div class="card">
                      <div class="card-header bg-rgba-salmon-strong">
                        <?php _e('Monitor your sales and grow your online business', 'woocpr'); ?>
                      </div>
                      <div class="card-body "> 
                        <div class="row">
            ...
            <div class="row" >
            	<div class="col-md-12">
         			<div class="card">
                      <div class="card-header bg-rgba-salmon-strong">
                        <?php _e('Dashboard - Sales Analysis', 'woocpr'); ?>
                      </div>
                      <div class="card-body"> 
                        <div class="row">
                           <div class="col-xl-3 col-md-6 col-lg-4   box10">
							  <div class="card card-border-top card-border-top-box10  shadow p-3 mb-4 bg-white rounded">
                                  <div class="card-body card-body-padding" >
									...
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong> <?php _e('Total Sales', 'woocpr'); ?></strong></h6>
						   ...
						   <div class="col-xl-3 col-md-6 col-lg-4   box1">
							  <div class="card card-border-top card-border-top-box1  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('This Year Sales', 'woocpr'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
						   ...
						   <div class="col-xl-3 col-md-6 col-lg-4   box4">
							  <div class="card card-border-top card-border-top-box4  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('This Month Sales', 'woocpr'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
						   ...
						   <div class="col-xl-3 col-md-6 col-lg-4   box6">
							  <div class="card card-border-top card-border-top-box6  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('This Week Sales', 'woocpr'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
                           ...
                           <div class="col-xl-3 col-md-6 col-lg-4   box8">
							  <div class="card card-border-top card-border-top-box8  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong> <?php _e('Yesterday Sales', 'woocpr'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
                           ...
                           <div class="col-xl-3 col-md-6 col-lg-4   box10">
							  <div class="card card-border-top card-border-top-box10  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong> <?php _e('Total Sales Count', 'woocpr'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
						   ...
						   <div class="col-xl-3 col-md-6 col-lg-4   box1">
							  <div class="card card-border-top card-border-top-box1  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('This Year Sales Count', 'woocpr'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
						   ...
						   <div class="col-xl-3 col-md-6 col-lg-4   box4">
							  <div class="card card-border-top card-border-top-box4  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('This Month Sales Count', 'woocpr'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
						   ...
						   <div class="col-xl-3 col-md-6 col-lg-4   box6">
							  <div class="card card-border-top card-border-top-box6  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('This Week Sales Count', 'woocpr'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
                           ...
                           <div class="col-xl-3 col-md-6 col-lg-4   box8">
							  <div class="card card-border-top card-border-top-box8  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong> <?php _e('Yesterday Sales Count', 'woocpr'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
            ...
            <div class="row" >
            	<div class="col-md-12" >
         			<div class="card">
                      <div class="card-header bg-rgba-salmon-strong">
                        <?php _e('Customer Analysis', 'woocpr'); ?> 
                      </div>
                      <div class="card-body "> 
                        <div class="row">
                           <div class="col-xl-3 col-md-6 col-lg-4   box10">
							  <div class="card card-border-top card-border-top-box10  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong> <?php _e('Total Customer Count', 'woocpr'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
						   ...
						   <div class="col-xl-3 col-md-6 col-lg-4   box1">
							  <div class="card card-border-top card-border-top-box1  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('Today Customer Count', 'woocpr'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
						   ...
						   <div class="col-xl-3 col-md-6 col-lg-4   box4">
							  <div class="card card-border-top card-border-top-box4  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('Total Guest Customer Count', 'woocpr'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
						   ...
						   <div class="col-xl-3 col-md-6 col-lg-4   box6">
							  <div class="card card-border-top card-border-top-box6  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('Today Guest Cust. Count', 'woocpr'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
            ...
            <div class="row" >
            	<div class="col-md-12" >
         			<div class="card">
                      <div class="card-header bg-rgba-salmon-strong">
                       <?php _e('Today  Sales Analysis', 'woocpr'); ?>
                      </div>
                      <div class="card-body "> 
                        <div class="row">
                           <div class="col-xl-3 col-md-6 col-lg-4   box10">
							  <div class="card card-border-top card-border-top-box10  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong> <?php _e('Today Order Count', 'woocpr'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
						   ...
						   <div class="col-xl-3 col-md-6 col-lg-4   box1">
							  <div class="card card-border-top card-border-top-box1  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('Today Sales', 'woocpr'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
						   ...
						   <div class="col-xl-3 col-md-6 col-lg-4   box4">
							  <div class="card card-border-top card-border-top-box4  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('Today Product Sold', 'woocpr'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
                           ...
                           <div class="col-xl-3 col-md-6 col-lg-4   box6">
							  <div class="card card-border-top card-border-top-box6  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('Today Discount', 'woocpr'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
                           ...
                           <div class="col-xl-3 col-md-6 col-lg-4   box6">
							  <div class="card card-border-top card-border-top-box6  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('Today Tax', 'woocpr'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
                        ...
                        <div class="row">
                           <div class="col-xl-3 col-md-6 col-lg-4   box10">
							  <div class="card card-border-top card-border-top-box10  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong> <?php _e('Low in stock', 'woocpr'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
						   ...
						   <div class="col-xl-3 col-md-6 col-lg-4   box1">
							  <div class="card card-border-top card-border-top-box1  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('Out of stock', 'woocpr'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
						   ...
						   <div class="col-xl-3 col-md-6 col-lg-4   box4">
							  <div class="card card-border-top card-border-top-box4  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('Most Stocked', 'woocpr'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
            ...
            <div class="row" >
            	<div class="col-md-12">
         			<div class="card">
                      <div class="card-header bg-rgba-salmon-strong">
                     <?php _e( 'recent orders', 'woocpr'); ?>
                      </div>
                      <div class="card-body "> 
                        <div class="row">
                        	<div class="table-responsive woocpr-table">
                            	<table class="table table-striped table-hover">
                    	 <thead class="shadow-sm p-3 mb-5 bg-white rounded">
                        	<tr>
                           <th><?php _e( 'Order ID', 'woocpr'); ?></th>
                            <th><?php _e( 'Order Date', 'woocpr'); ?> </th>
                            <th><?php _e( 'First Name', 'woocpr'); ?> </th>
                            <th><?php _e( 'Billing Email', 'woocpr'); ?></th>
                            <th><?php _e( 'Country', 'woocpr'); ?> </th>
                            <th><?php _e( 'Order Status', 'woocpr'); ?>  </th>
                            <th><?php _e( 'Currency', 'woocpr'); ?> </th>
                            <th class="text-right"><?php _e( 'Order Total', 'woocpr'); ?>  </th>
						</tr>
                        </thead>
                        ...
                        <div class="row">
                            ...
                            <div class="table-responsive woocpr-table">
                        	 ...
                        	 <thead class="shadow-sm p-3 mb-5 bg-white rounded">
                            	<tr>
                                <th><?php _e('Order Status', 'woocpr'); ?></th>
                                <th><?php _e('Order Count', 'woocpr'); ?></th>
                                <th><?php _e('Order Total', 'woocpr'); ?></th>
                            	</tr>
                            </thead>
                      ...
                      <div class="card-body "> 
                        <div class="row">
                            ...
                            <div class="table-responsive woocpr-table">
                        	 ...
                        	 <thead class="shadow-sm p-3 mb-5 bg-white rounded">
                            	<tr>
                                <th><?php _e( 'Payment Method', 'woocpr'); ?> </th>
                                <th><?php _e( 'Order Count', 'woocpr'); ?></th>
                                <th><?php _e( 'Order Total', 'woocpr'); ?></th>
                            </tr>
                            </thead>
            ...
            <div class="row" >
            	<div class="col-md-6"  >
         			<div class="card">
                      <div class="card-header bg-rgba-salmon-strong">
                    <?php _e('Top 5 Customer Report', 'woocpr'); ?>
                      </div>
                      <div class="card-body "> 
                        <div class="row">
                            ...
                            <div class="table-responsive woocpr-table">
                        	 ...
                        	 <thead class="shadow-sm p-3 mb-5 bg-white rounded">
                            	<tr>
                                <th><?php _e('First Name', 'woocpr'); ?>  </th>
                                <th><?php _e('Email Address', 'woocpr'); ?></th>
                                <th><?php _e('Order Count', 'woocpr'); ?></th>
                                <th><?php _e('Order Total', 'woocpr'); ?></th>
                            </tr>
                            </thead>
							...
							?>
                            <tr>
                            	<td colspan="4"><?php _e('No Customer found', 'woocpr'); ?></td>
                            </tr>
                            <?php
							} 
							 ?>
                ...
                <div class="col-md-6" >
         			<div class="card">
                      <div class="card-header bg-rgba-salmon-strong">
                  <?php _e('TOP 5 Country REPORT', 'woocpr'); ?> 
                      </div>
                      <div class="card-body "> 
                        <div class="row">
                        	<div class="col-sm-12 col-md-12 col-lg-12">
